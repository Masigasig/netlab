  ...
  List<ContentModule> getContentModules() {
    return [
      ...
      ContentModule(
        id: 'nd_hub_quiz',
        title: 'Hub Quiz',
        description: 'Test your knowledge on network hubs',
        icon: Icons.hub, // HugeIcons.strokeRoundedArrowAllDirection,
        duration: 10,
        type: ContentType.quiz,
      ),
      ...
      ContentModule(
        id: 'nd_bridge_quiz',
        title: 'Bridge Quiz',
        description: 'Test your knowledge on network bridges',
        icon: Icons.link, // HugeIcons.strokeRoundedLink03,
        duration: 10,
        type: ContentType.quiz,
      ),
      ...
      ContentModule(
        id: 'nd_switch_quiz',
        title: 'Switch Quiz',
        description: 'Test your knowledge on network switches',
        icon: Icons
            .switch_access_shortcut, // HugeIcons.strokeRoundedCurvyLeftRightDirection,
        duration: 10,
        type: ContentType.quiz,
      ...
      ContentModule(
        id: 'nd_router_quiz',
        title: 'Router Quiz',
        description: 'Test your knowledge on routers',
        icon: Icons.router, // HugeIcons.strokeRoundedRouter02,
        duration: 10,
        type: ContentType.quiz,
      ),
      ContentModule(
        id: 'nd_topic_quiz',
        title: 'Network Devices Topic Quiz',
        description: 'Final assessment covering all network devices concepts',
