              ...
              child: Column(
                ...
                children: [
                  ...
                  ...json.entries.map((entry) {
                    ...
                    final index = json.entries.toList().indexOf(entry);

                    return AnimationPresets.listItemSlideRight(
                      child: ChapterCard(chapterId: chapterKey),
                      index: index + 1, // Add 1 to ensure index is never 0
                      staggerDelay: 150,
                    );
                  }),
                ],
